...
## 1. define o caminho relativo do aruqivo rds
caminho_rds <- here("dados/limpos/dados_vendas_limpos.rds")
...
# salva o resultadi em um novo objeto 
...
#remove a coluna representante e cidade
dados_vendas_limpos |> 
...
# cria a variável preco_desconto (10% sobre o preço_unitário)
dados_vendas_limpos |> 
  mutate(preço_desconto = preco_unitario * 0.9)
...
# Calcula os números de representantes distintos nos dados
dados_vendas_limpos |> 
  summarise(numero_representantes= n_distinct(representante))

# Calcula o número total de vendas reaizadas
dados_vendas_limpos |> 
